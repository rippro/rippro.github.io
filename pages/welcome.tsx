  ...
  return (
    ...
    >
      <div className={`${styles.section} ${welcomeStyles.line}`}>
        ...
        <p>
          プログラミングって何？と思う方、どこの学部の方でもでも歓迎するので気軽に参加してください。
        </p>
        <ul className={welcomeStyles.list}>
          ...
          <li>時間 : {courseTime}</li>
          <li>
            内容 : プログラミングの初め方・C言語の基礎から (C++
            にも少し触れます)
          </li>
        </ul>
        <p style={{ color: "red" }}>
          {isCourceOpen ? "" : "※現在は終了しています"}
        </p>
        <div>
          ...
          <ul>
            ...
            <li>
              <a href="https://www.slideshare.net/rippro/ss-75063033">
                条件分岐・繰り返し
              </a>
            </li>
            <li>
        ...
        <div className={welcomeStyles.line}>
          <p>
            私たち
            RiPProは競技プログラミングの能力を高めコンテストでの入賞を目指す団体です。
          </p>
        ...
        <YouTube
          videoId="Q4gTV4r0zRs"
          className={welcomeStyles.iframe}
          containerClassName={welcomeStyles.youtube}
        />
        <div className={welcomeStyles.line}>
          <p>
