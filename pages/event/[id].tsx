          ...
          return (
            <tr className={detailsStyle.tr} key={commentary.title}>
              ...
              <td className={detailsStyle.td}>
                <a
                  href={`/static/contestData/${Props.contestId}/${commentary.link}`}
                >
    ...
    >
      <div className={styles.section}>
        ...
        <PictureElement
          ...
          link={getEntries(contestId, "picture")}
        />
        ...
        <ProblemSetElement
          problemSet={getEntries(contestId, "problemSet")}
          contestId={contestId || defaultId}
        />
        <CommentaryElement
          contestId={contestId || defaultId}
